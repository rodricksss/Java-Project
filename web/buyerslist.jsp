<%-- 
    Document   : buyerslist
    Created on : 18 Apr, 2014, 11:39:14 PM
    Author     : Mannu
--%>
...
<html>
    ...
    <body>
         ...
         <%@include file="master.jsp" %>
          <%
            try {
                ...
                String str = request.getParameter("button2");
                
                if (str.equals("View")) 
                {
                    rd = request.getRequestDispatcher("buyerview.jsp");
                    rd.forward(request, response);
                }

                if (str.equals("Delete")) 
                {
                    rd = request.getRequestDispatcher("BuyerDeleteServlet");
                    rd.forward(request, response);
                }
            } 
            catch (Exception ex) 
        ...
        <%
            ...
            MyConnection.pst = MyConnection.con.prepareStatement("select * from buyer");
			...
			<form id="mainform" action="">
				...
				<tr>
					<form action="" method="post">
                                            ...
                                            <input type="hidden" name="buyerid" value="<%=rs.getInt("buyer_id")%>"/>
                                            <td><%=count%></td>
                                            ...
                                            <td><input type="submit" name="button2" value="View" class="btn btn-blue"/></td>
                                            <td><input type="submit" name="button2" value="Delete" class="btn btn-blue"/></td>  
                                        </form>
                                            <%
                                                }
                                            %>
				...
				<!--  end product-table................................... --> 
                                ...
                                <table>
                                    <thead>
                                        <th>
                                            <form action="buyerreg.jsp" method="post">
                                                <input type="submit" value="Add New Buyer" style="margin-left:550px; width: 200px;" class="btn btn-blue"/>
                                            </form>
                                        </th>
                                    </thead>
                                </table>
