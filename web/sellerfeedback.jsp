<%-- 
    Document   : sellerfeedback
    Created on : 16 May, 2014, 9:35:35 PM
    Author     : sony
--%>
            ...
            if(str.equals("Submit"))
            {
                try
                {
                    ...
                    if(row>0)
                    {
                        ...
                        response.sendRedirect("sellerfeedback.jsp");
                    }
                }
	...
	<tr>
		...
		<div id="content-table-inner">
            ...
            <%
                ...
                int sid=(Integer)sess.getAttribute("seller_id");
                MyConnection.pst.close();
                MyConnection.pst=MyConnection.con.prepareStatement("select f_name,l_name,email_id from seller where seller_id=?");
                MyConnection.pst.setInt(1,sid);
                resultSet=MyConnection.pst.executeQuery();
                while(resultSet.next())
                {              
            %>
        <form action="sellerfeedback.jsp" method="post">
            <table>
