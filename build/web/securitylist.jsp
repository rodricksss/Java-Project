<%-- 
    Document   : securitylist
    Created on : 19 Apr, 2014, 12:22:21 AM
    Author     : Mannu
--%>
		...
		<div id="content-table-inner">
			...
			<form id="mainform" action="">
				<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
					...
					<th class="table-header-repeat line-left"><a href="">Security Question</a>	</th>
				...
				<tr>
					<form action="" method="post">                        
                                            <input type="hidden" name="securityid" value="<%=rs.getInt("security_id")%>"/>
                                            <td><%=count%></td>
                                            <td><%=rs.getString("security_ques")%></td>                         
                                        </form>
                                            <%
                                                }
                                            %>
				...
				<!--  end product-table................................... --> 
                                ...
                                <table>
                                    <thead>
                                        <th>
                                            <form action="securityreg.jsp" method="post">
