<%-- 
    Document   : citylist
    Created on : 19 Apr, 2014, 12:07:52 AM
    Author     : Mannu
--%>
    ...
    <body>
        ...
        <%@include file="master.jsp" %>
         <%
            ...
            MyConnection.pst = MyConnection.con.prepareStatement("select * from city");
		...
		<div id="content-table-inner">
			...
			<form id="mainform" action="">
				<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
					...
					<th class="table-header-repeat line-left"><a href="">City Name</a>	</th>
				...
				<tr>
					<form action="citylist.jsp" method="post">
                                            <input type="hidden" name="cityid" value="<%=rs.getInt("city_id")%>"/>
                                            <td><%=count%></td>
				...
				<!--  end product-table................................... --> 
                                ...
                                <table>
                                    <thead>
                                        <th>
                                            <form action="cityreg.jsp" method="post">
