<%-- 
    Document   : subcategoryreg
    Created on : 19 Apr, 2014, 1:26:41 AM
    Author     : Mannu
--%>
...
<div id="content">
	...
	<tr>
		...
		<div id="content-table-inner">
            ...
            ResultSet rs;
        %>
        <form action="SubCategorySaveServlet" method="post">
            <table>
                <tr><td><label>Category Name:</label></td><td><select name="catid">
                ...
                <tr><td><label>Sub Category Name:</label></td><td><input type="text" name="subcategory" value=""/></td></tr>
            </table>
            <br><input type="submit" value="Submit" class="btn btn-blue"/><br/><br/>            
        </form>
        
        </form>
        <form action="subcategorylist.jsp" method="post">
