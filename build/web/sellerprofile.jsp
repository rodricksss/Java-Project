<%-- 
    ...
    Created on : 25 Apr, 2014, 1:30:02 PM
    Author     : Neha
--%>
...
<div id="content">
	...
	<tr>
		...
		<div id="content-table-inner">
            ...
            <form enctype="multipart/form-data" action="SellerImageInsert" method="post">
            <input type="file" name="file"/>
            <input type="submit" name="submit" value="Upload" class="btn btn-blue"/> </h2>
                       <b>Username: </b><h3><%=sess.getAttribute("sellerid")%></h3>
                       <b>Session Id: </b><h3><%=sess.getId()%></h3>
                        ...
                        This allows you to change the existing properties according to the requirements felt necessary.<br/><br/>		
			
                        As per the plan selected by you, you can access your account only within the bounds of the duration allocated.<br/>
                        You can add as many properties to sell but when your plan expires then you have to renew your plan or otherwise your account will be deactivated.
                        </div>
			<!--  end table-content  -->
