...
import connections.CategoryModel;
...
public class CategorySaveServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            cab.setCatname(catname);
            
            CategoryModel cam = new CategoryModel();
            boolean flag = cam.categoryInsert(cab);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CategorySaveServlet</title>");            
            out.println("</head>");
            out.println("<body>");
