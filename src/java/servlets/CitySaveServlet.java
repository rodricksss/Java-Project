...
public class CitySaveServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String ciname = request.getParameter("city").trim();
            
            RequestDispatcher rd = null;

            CityBean cib = new CityBean();
            cib.setCityname(ciname);
            cib.setStateid(stateid);
            
            CityModel st = new CityModel();
            boolean flag = st.cityInsert(cib);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CitySaveServlet</title>");            
            out.println("</head>");
            out.println("<body>");
